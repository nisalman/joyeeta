...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.locale = {
            ...
            firstDay: 1 // Segunda-Feira como 1º dia da Semana
    ...
    DateRangePicker.prototype = {
        ...
        clickDate: function(e) {
            ...
            if (this.singleDatePicker) {
                ...
                if (!this.timePicker && this.autoUpdateInput)
                    this.clickApply();
            }
...
$(function() {
    $('input[name="singlepicker"]').daterangepicker({
    ...
    $('input[name="rangepicker"]').daterangepicker({
        ...
        timePicker: true,
        startDate: '17/04/2017 09:00',
        endDate: '17/05/2017 09:00'
    });
});
