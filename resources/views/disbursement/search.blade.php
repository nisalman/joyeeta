...
<div class="form-group row">
    ...
    <div class="col-lg-5 col-md-12 col-sm-12">
        <div class="input-group" data-date="12/07/2017" data-date-format="mm/dd/yyyy">
            <input type="datetime-local"  class="form-control" placeholder="from date" name="from" value="{{old('from')}}">
            <span class="px-3 py-2">To</span>
            <input type="datetime-local" class="form-control rounded dpd2" name="to" value="{{old('to')}}">
        </div>
    </div>
